...
enemy_death = pygame.mixer.Sound("invaderkilled.wav")
music = pygame.mixer.music.load("Surak_-_07_-_A_comet_is_born.wav")
...
def main():
    ...
    while run:
        ...
        for enemy in enemies[:]:
            ...
            if random.randrange(0, 120) == 1:#picking a probability of shooting each frame
                enemy.shoot()
